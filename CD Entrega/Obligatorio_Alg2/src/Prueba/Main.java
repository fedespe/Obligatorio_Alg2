...
public class Main {
    ...
    public static void JuegoDePrueba(Sistema s, Prueba p){
        ...
        p.ver(s.procesarInformacion(1.0, 1.0, 10).resultado, Retorno.Resultado.ERROR_1, "Se manda solicitud de procesamiento a un punto inexistente.");
        p.ver(s.procesarInformacion(-31.58, -55.24, 20).resultado, Retorno.Resultado.ERROR_2, "Se manda solicitud de procesamiento a un DataCenter existente pero con una cantidad de información que ninguno puede procesar.");
        p.ver(s.procesarInformacion(-31.58, -55.24, 5).resultado, Retorno.Resultado.OK, "Se manda solicitud de procesamiento que da OK en el mismo DC inicial.");
        p.ver(s.procesarInformacion(-32.63, -57.17, 8).resultado, Retorno.Resultado.OK, "Se manda solicitud de procesamiento que da OK en otro DC.");
        p.ver(s.procesarInformacion(-31.58, -55.24, 6).resultado, Retorno.Resultado.OK, "Se manda solicitud de procesamiento que da OK en otro DC debido a que al incial se le había bajado la capacidad directamente.");
        p.ver(s.procesarInformacion(-33.88, -53.98, 2).resultado, Retorno.Resultado.OK, "Se manda solicitud de procesamiento que da OK en otro DC debido a que al incial se le había bajado la capacidad indirectamente.");
        ...
        //Requerimiento 3.3 - Listado de red mínima requerida
