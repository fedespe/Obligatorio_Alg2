...
public class TestObligatorio {
	...
	public void testProcesarInformacion()
	{
		...
		assertEquals(Retorno.Resultado.OK, res.resultado);
		assertEquals("West Virginia", res.valorString);
		assertEquals(100, res.valorEntero); //Viso que retornamos el costo de la operación en el valor entero del resultado, modificamos el juego de prueba
	}
